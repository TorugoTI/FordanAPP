...
public class pg4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nao.setOnClickListener(v -> {
            tel = "Não possuo o número";

            DatabaseReference reference = db.getReference().child("users").child(id).child("Pensão");
            reference.child("PGT4").setValue(tel);

            Intent perfil = new Intent(pg4.this,pg5.class);
        ...
        speak.setOnClickListener(view -> {
            String text = "O (A) senhor (a) possui o número de telefone do genitor (a)? Caso afirmativo, nos informe" ;
            t1.speak(text, TextToSpeech.QUEUE_FLUSH, null);
        });

        t1 = new TextToSpeech(pg4.this, i -> {
    ...
    private void volto(){
        Intent in = new Intent( pg4.this, pg3.class);
        startActivity(in);
        finish();
    }
}
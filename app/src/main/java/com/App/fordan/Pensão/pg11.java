...
public class pg11 extends AppCompatActivity {
    Button salvar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pg11);
        ...
        speak.setOnClickListener(view -> {
            String text = "Desde o fim do relacionamento, o filho está residindo com o(a) senhor(a)?";
            t1.speak(text, TextToSpeech.QUEUE_FLUSH, null);
        });
        t1 = new TextToSpeech(pg11.this, i -> {
    ...
    private void salvar_dados(){
        ...
        reference.child("PGT11").setValue(Pgt);

        Intent perfil = new Intent(pg11.this, pg12.class);
    ...
    private void volto() {
        Intent in = new Intent( pg11.this, pg10.class);
        startActivity(in);
        finish();
    }
}
...
public class pg9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speak.setOnClickListener(view -> {
            String text = "Informe a conta, agência, banco e nome completo do titular do cartão em que o valor deve ser depositado ou informe se deseja receber o valor em mãos mediante recibo.";
            t1.speak(text, TextToSpeech.QUEUE_FLUSH, null);
        });
        t1 = new TextToSpeech(pg9.this, i -> {
    ...
    private void salvar_dados(){
        ...
        reference.child("PGT9").setValue(Pgt);

        Intent perfil = new Intent(pg9.this, pg10.class);
    ...
    private void volto() {
        Intent in = new Intent( pg9.this, pg8.class);
        startActivity(in);
        finish();
    }
}
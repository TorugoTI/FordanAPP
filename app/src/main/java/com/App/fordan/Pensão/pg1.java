...
public class pg1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speak.setOnClickListener(view -> {
            String text = "endereço residencial completo do genitor que pagará a pensão";
            t1.speak(text, TextToSpeech.QUEUE_FLUSH, null);
        });
        t1 = new TextToSpeech(pg1.this, i -> {
    ...
    private void salvar_dados(){
        ...
        reference.child("PGT1").setValue(Pgt);

        Intent perfil = new Intent(pg1.this, pg2.class);
    ...
    private void volto() {
        Intent in = new Intent( pg1.this, Acoes.class);
        startActivity(in);
        finish();
    }
}
...
public class pg8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nao.setOnClickListener(v -> {
            ...
            reference.child("PGT8").setValue(tel);

            Intent perfil = new Intent(pg8.this,pg9.class);
        ...
        speak.setOnClickListener(view -> {
            String text = "O (A) genitor (a) que pagará a pensão já contribui com algum valor de forma espontânea? Caso positivo, qual o valor? O valor é insuficiente? Houve tentativa de acordo com a parte requerida?" ;
            t1.speak(text, TextToSpeech.QUEUE_FLUSH, null);
        });

        t1 = new TextToSpeech(pg8.this, i -> {
    ...
    private void volto(){
        Intent in = new Intent( pg8.this, pg7.class);
        startActivity(in);
        finish();
    }
}
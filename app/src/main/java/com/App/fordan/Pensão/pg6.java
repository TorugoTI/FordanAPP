...
public class pg6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speak.setOnClickListener(view -> {
            String text = "Qual o gasto mensal da criança? Possui comprovante dos gastos tais como despesas escolares, farmácia, alimentação, vestuário, tratamento médico, dentário, entre outros, favor nos encaminhar durante o atendimento.";
            t1.speak(text, TextToSpeech.QUEUE_FLUSH, null);
        });
        t1 = new TextToSpeech(pg6.this, i -> {
    ...
    private void salvar_dados(){
        ...
        reference.child("PGT6").setValue(Pgt);

        Intent perfil = new Intent(pg6.this, pg7.class);
    ...
    private void volto() {
        Intent in = new Intent( pg6.this, pg5.class);
        startActivity(in);
        finish();
    }
}
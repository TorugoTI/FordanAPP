...
public class pg3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speak.setOnClickListener(view -> {
            String text = "O(a) senhor(a) possui o número do RG e/ou CPF do requerido(a)?";
            t1.speak(text, TextToSpeech.QUEUE_FLUSH, null);
        });
        t1 = new TextToSpeech(pg3.this, i -> {
    ...
    private void salvar_dados(){
        ...
        reference.child("PGT3").setValue(Pgt);

        Intent perfil = new Intent(pg3.this, pg4.class);
    ...
    private void volto() {
        Intent in = new Intent( pg3.this, pg2.class);
        startActivity(in);
        finish();
    }
}
...
public class pg10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pg10);
        ...
        speak.setOnClickListener(view -> {
            String text = "Considerando as necessidades do(s) filho(s) e a condição econômica do (a) requerido (a), qual o valor de pensão que deseja pedir?";
            t1.speak(text, TextToSpeech.QUEUE_FLUSH, null);
        });
        t1 = new TextToSpeech(pg10.this, i -> {
    ...
    private void salvar_dados(){
        ...
        reference.child("PGT10").setValue(Pgt);

        Intent perfil = new Intent(pg10.this, pg11.class);
    ...
    private void volto() {
        Intent in = new Intent( pg10.this, pg9.class);
        startActivity(in);
        finish();
    }
}
...
public class Local_indigena extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_local_indigena);
        ...
        salvar.setOnClickListener(v -> {
            salvar_dados();
            Intent perfil = new Intent(Local_indigena.this, Escolaridade.class);
            startActivity(perfil);

        });
        speak.setOnClickListener(view -> {
            String text = "Digite a localização do seu Povo ou Clique no Mic e Fale a localização do seu Povo";
            t1.speak(text, TextToSpeech.QUEUE_FLUSH, null);
        });
        t1 = new TextToSpeech(Local_indigena.this, i -> {
    ...
    private void salvar_dados(){
        ...
        if (locos.isEmpty()) {
            local.setError("Por Favor Preencha com a localização do seu Povo");
            String text2 = "Por Favor Preencha com a localização do seu Povo";
    ...
    private void volto() {
        Intent in = new Intent( Local_indigena.this, Povo.class);
        startActivity(in);
        finish();
    }
}